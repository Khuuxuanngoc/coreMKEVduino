...
#elif defined(__AVR__) // kxn
// IR_RECEIVE_PIN use pin change interrupts.
#define IR_RECEIVE_PIN      A1//10 ok//9 ok//11 ok //2 // To be compatible with interrupt example, pin 2 is chosen here. Ko anh huong pwm 9-10
#define IR_SEND_PIN         11//9//3
// #define TONE_PIN            10//4
// #define APPLICATION_PIN     5
// #define ALTERNATIVE_IR_FEEDBACK_LED_PIN 6 // E.g. used for examples which use LED_BUILDIN for example output.
// #define _IR_TIMING_TEST_PIN  7
#define PWM_PIN_TEST        9
