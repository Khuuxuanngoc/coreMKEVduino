...
int lowValueWarning             = 100;              // Set value of LOW Level
int highValueWarning            = 300;              // Set value of HIGH Level
int sensorValue                 = 0;                // Declare value variable
void setup(){
    Serial.begin(9600);                 // Baudrate 9600
    Serial.println("MakerEdu.vn Demo Read MKE-S08_MQ-2_LPG_CO_CH4_sensor And Control Led");
