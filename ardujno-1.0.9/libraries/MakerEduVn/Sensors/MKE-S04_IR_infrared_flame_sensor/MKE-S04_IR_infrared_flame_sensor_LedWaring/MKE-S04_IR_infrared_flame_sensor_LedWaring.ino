...
*/
const int flame_sensor_pin       = A1;               // Declare input ADC pin
int led_Warning_Pin             = D11;              // Declare Output Led pin
unsigned char warningFlag       = MID;              // Declare Level variable
int lowValueWarning             = 200;              // Set value of LOW Level
int highValueWarning            = 500;              // Set value of HIGH Level
int sensorValue                 = 0;                // Declare value variable
void setup(){
    Serial.begin(9600);                 // Baudrate 9600
    Serial.println("MakerEdu.vn Demo Read MKE-S04_IR_infrared_flame_sensor And Control Led");
