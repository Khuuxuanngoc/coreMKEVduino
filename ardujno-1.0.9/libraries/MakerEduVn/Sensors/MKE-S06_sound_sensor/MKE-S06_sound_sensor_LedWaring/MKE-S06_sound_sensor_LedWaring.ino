...
int lowValueWarning             = 330;              // Set value of LOW Level
int highValueWarning            = 390;              // Set value of HIGH Level
int sensorValue                 = 0;                // Declare value variable
void setup(){
    Serial.begin(9600);                 // Baudrate 9600
    Serial.println("MakerEdu.vn Demo Read MKE-S06_sound_sensor And Control Led");
...
void loop(){
    ...
    */
    ...
    delay(10); // Wait 100ms then repeat
}
